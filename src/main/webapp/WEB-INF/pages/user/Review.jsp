                ...
                <div class="review-main">
                    ...
                    <div class="payment-section">
                        ...
                        <div class="payment-grid">
                            <div class="payment-card selected"><i class="fa-solid fa-wallet"></i><span>ESEWA</span></div>
                            <div class="payment-card"><i class="fa-solid fa-wallet"></i><span>KHALTI</span></div>
                            <div class="payment-card"><i class="fa-solid fa-qrcode"></i><span>QR PAY</span></div>
                        </div>
                    </div>
                </div>
