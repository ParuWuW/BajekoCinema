...
--
-- Host: 127.0.0.1
-- Generation Time: May 20, 2026 at 06:21 PM
...
INSERT INTO `booking` (`booking_id`, `user_id`, `show_id`, `booking_time`, `total_amount`, `status`) VALUES
(1, 6, 24, '2026-05-20 15:43:39', 400.00, 'cancelled'),
(2, 6, 13, '2026-05-20 16:05:01', 400.00, 'confirmed');
...
(1, 'Dune: Part Two', 'SciFi', 'Paul Atreides unites with Chani and the Fremen while seeking revenge against the conspirators who destroyed his family.', 166, '2024-02-28', 'resources/images/dune.png', 'https://www.youtube.com/embed/3_9vCamtuPY', 8.7, 'now_showing'),
(2, 'Oppenheimer', 'Thriller', 'The story of American scientist J. Robert Oppenheimer and his role in the development of the atomic bomb.', 180, '2023-07-21', 'resources/images/oppenheimer.png', 'https://www.youtube.com/embed/bK6ldnjE3Y0', 8.5, 'now_showing'),
(3, 'Barbie', 'Comedy', 'Barbie and Ken discover the joys and perils of living in the real world.', 114, '2023-07-21', 'resources/images/barbie.png', 'https://www.youtube.com/embed/8zIf0XvoL9Y', 7.0, 'now_showing'),
(4, 'Killers of the Flower Moon', 'Thriller', 'Members of the Osage tribe are murdered under mysterious circumstances in the 1920s.', 206, '2023-10-20', 'resources/images/flowermoon.png', 'https://www.youtube.com/embed/EP34Yoxs3FQ', 8.0, 'now_showing'),
(5, 'Poor Things', 'Fantasy', 'The incredible tale of Bella Baxter, a young woman brought back to life by an unorthodox scientist.', 141, '2023-12-08', 'resources/images/poorthings.png', 'https://www.youtube.com/embed/RlbR5N6veqw', 8.1, 'now_showing'),
(6, 'Deadpool 3', 'Action', 'Wade Wilson returns for another meta, violent, and hilarious adventure.', 127, '2024-07-26', 'resources/images/deadpool.png', 'https://www.youtube.com/embed/73_1biulkYk', 0.0, 'upcoming'),
(7, 'Joker: Folie à Deux', 'Thriller', 'Sequel to Joker, featuring Arthur Fleck and Harley Quinn.', 138, '2024-10-04', 'resources/images/jocker.png', 'https://www.youtube.com/embed/xy8aJw1vYHo', 0.0, 'upcoming'),
...
INSERT INTO `ticket` (`ticket_id`, `booking_id`, `status`) VALUES
(3, 1, 'cancelled'),
(4, 2, 'cancelled');
...
INSERT INTO `ticket_seat` (`ticket_seat_id`, `ticket_id`, `seat_id`, `seat_price`) VALUES
(1, 3, 116, 200.00),
(2, 3, 117, 200.00),
(3, 4, 33, 200.00),
(4, 4, 34, 200.00);
...
--
ALTER TABLE `ticket_seat`
  MODIFY `ticket_seat_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
